...
namespace Tees.ViewModels
{
    public class ProductViewModel
    {
        ...
        [StringLength(50, MinimumLength = 3, ErrorMessage = "Product title must be betwen 3 and 50 characters")]
        [RegularExpression(@"^[a-zA-Z0-9'-'\s]*$", ErrorMessage = "Product titles can only contain letters and numbers")]
        ...
        [RegularExpression("[0-9]+(\\.[0-9][0-9]?)?", ErrorMessage = "The price can only be up to two decimal places")]
